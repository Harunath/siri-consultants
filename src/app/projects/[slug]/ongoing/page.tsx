		...
		<section className="pt-32 pb-20 bg-gradient-to-b from-[#052B59] to-[#021933] min-h-screen text-white">
			<div className="max-w-7xl mx-auto px-6">
				...
				<div className="mb-10">
					...
					<p className="text-gray-300 mt-2">Ongoing Projects Overview</p>
				...
				{project.ongoing.length === 0 ? (
					...
					<div className="overflow-x-auto rounded-2xl shadow-lg">
						<table className="w-full text-left border-collapse">
							...
							{/* BODY */}
							<tbody>
								{project.ongoing.map((item, index) => (
									<tr
										key={item.id}
										...
										<td className="px-6 py-4 text-center">
											<span className="px-3 py-1 text-xs rounded-full bg-yellow-500/20 text-yellow-300 font-semibold">
												In Progress
											</span>
										</td>
									</tr>
